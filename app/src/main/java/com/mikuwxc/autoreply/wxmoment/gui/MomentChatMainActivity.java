package com.mikuwxc.autoreply.wxmoment.gui;
...
import com.mikuwxc.autoreply.wxmoment.SnsStat;
import com.mikuwxc.autoreply.wxmoment.Task;
import com.mikuwxc.autoreply.wxmoment.common.Share;


public class MomentChatMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_moment_wchat);
        task.testRoot();
    ...
    class RunningTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void voidParam) {
            ...
            Intent intent = new Intent(MomentChatMainActivity.this, MomentStatActivity.class);
